...
namespace Infrastructure.SaveLastVisitedPageMiddlewareX
{
    public class SaveLastVisitedX
    {
        private readonly RequestDelegate _next;
        private readonly ILogger<SaveLastVisitedX> _logger;

        public SaveLastVisitedX(RequestDelegate next,
            ILogger<SaveLastVisitedX> logger)
        {
            _next = next;
            _logger = logger;
        }
